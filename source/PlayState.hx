...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'whipster':
				var bg = new BGSprite('whippster', 250, 0);
				bg.setGraphicSize(Std.int(2.4 * bg.width));
				add(bg);
		}
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		comboSpr.x += rating.x + ClientPrefs.comboOffset[0];
		comboSpr.y -= rating.y + ClientPrefs.comboOffset[1];
		comboSpr.y += 60;
